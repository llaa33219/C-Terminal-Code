 ...
 *    · CustomRenderer  (둥근 모서리 + 두꺼운 테두리)
 *    · ConstantProvider override
 *    · Full toolbox JSON  (원본 app.js 전체 블록)
 *    · Code run / save / load / share / resize
 * ───────────────────────────────────────────────────────── */
...
/* 1) ConstantProvider ‑ 모서리·탭·노치 등 값 원본 그대로 */
Blockly.blockRendering.ConstantProvider.prototype.CORNER_RADIUS         = 25;
Blockly.blockRendering.ConstantProvider.prototype.OUTSIDE_CORNER_RADIUS = 25;
Blockly.blockRendering.ConstantProvider.prototype.NO_PADDING            = 0;
Blockly.blockRendering.ConstantProvider.prototype.SHADOW_OFFSET         = 0;
Blockly.blockRendering.ConstantProvider.prototype.NOTCH_WIDTH           = 20;
Blockly.blockRendering.ConstantProvider.prototype.NOTCH_HEIGHT          = 15;
Blockly.blockRendering.ConstantProvider.prototype.TAB_HEIGHT            = 20;
Blockly.blockRendering.ConstantProvider.prototype.TAB_RADIUS            = 20;

/* 2) CustomRenderer – 내부 채우기 후 4 px 테두리 */
const BORDER_WIDTH = 4;
class CustomRenderer extends Blockly.blockRendering.Renderer {
  makePathObject(constants) {
    const pathObj = super.makePathObject(constants);
    const original = pathObj.drawSolidHighlighted;
    pathObj.drawSolidHighlighted = function(pattern, colour) {
      original.call(this, pattern, colour);
...
/* 4) Full Toolbox JSON – 원본 app.js 전체 블록 세트 */
const toolbox = {
